...
RSpec.describe RestaurantsController, type: :controller do
  ...
  describe 'GET #show' do
    it 'returns a success response' do
      restaurant = Restaurant.create! valid_attributes
      get :show, params: { local_id: restaurant.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested restaurant' do
        restaurant = Restaurant.create! valid_attributes
        put :update, params: { local_id: restaurant.to_param, restaurant: new_attributes }, session: valid_session
        restaurant.reload
      ...
      it 'renders a JSON response with the restaurant' do
        ...
        put :update, params: { local_id: restaurant.to_param, restaurant: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the restaurant' do
        ...
        put :update, params: { local_id: restaurant.to_param, restaurant: invalid_attributes }, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested restaurant' do
      restaurant = Restaurant.create! valid_attributes
      expect do
        delete :destroy, params: { local_id: restaurant.to_param }, session: valid_session
      end.to change(Restaurant, :count).by(-1)
    end
  end
end
